  ...
  module V1
    module Serializers
      class FilmMakerSerializer < ActiveModel::Serializer
        attributes :id, :name, :location, :avatar, :role, :description, :meta => {pagination: {total_pages: (User.all.count/10).ceil, current_page: params[:page], total_count: User.all.count}}
