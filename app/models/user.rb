class User < ActiveRecord::Base
  ...
  attr_accessible :name, :email, :location, :about, :imdb_url, :characteristics_attributes, :photos_attributes, :talents_attributes, :photo, :videos_attributes, :projects_attributes, :admin, :gender, :headline
