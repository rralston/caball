Caball::Application.configure do
  ...
  config.assets.precompile += %w( admin/admin.css admin/*.js conversations/new.css users/users_manifest.js dashboard/dashboard.css dashboard/dashboard_manifest.js users/users.js signup.css signin.css
                                ...
                                users/users_manifest.js users/manifest.css users/show.css contact.js glossary.js static_pages/labs.css dashboard/introjs.css dashboard/intro.js static_pages/home_additional.css)
  ...
  config.action_mailer.default_url_options = { :host => 'filmmo.com' }
